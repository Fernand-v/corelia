...
// Sub-servicio del flujo legacy de solicitudes (VACACIONES/PERMISO/ACCESO):
// creación, resolución y listado, con su encolado de notificaciones y webhooks.
// Extraído de FormService; self-contained sobre `app`.
