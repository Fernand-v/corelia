import {
  ...
  adminCreatePermissionInputSchema,
  adminCreateProgramInputSchema,
  ...
  adminListPermissionsQuerySchema,
  adminListProgramsQuerySchema,
  adminListResourcesQuerySchema,
  adminCreateResourceInputSchema,
  adminUpdateResourceInputSchema,
  adminListActionsQuerySchema,
  adminCreateActionInputSchema,
  adminUpdateActionInputSchema,
  adminOffboardingExecuteInputSchema,
  adminOffboardingPreviewInputSchema,
  adminReplaceRoleAccessInputSchema,
  ...
  adminUpdatePermissionInputSchema,
  adminUpdateProgramInputSchema,
