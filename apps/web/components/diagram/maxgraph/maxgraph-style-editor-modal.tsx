    ...
    <UiModal open={open} onClose={onClose} title="Editor de estilo avanzado" widthClassName="max-w-2xl">
      <div className="space-y-3">
        ...
        <textarea
          ...
          rows={8}
          className="w-full rounded-lg border border-line px-3 py-2 font-mono text-xs text-ink outline-none focus:border-line"
        />

        <div className="rounded-lg border border-line bg-line p-2">
          <p className="text-[11px] font-semibold uppercase tracking-wide text-mid">Preview parseado</p>
          <pre className="mt-1 max-h-40 overflow-auto text-[11px] text-ink">
